...
(printf "\nPart4 Tests")
(printf "\nP4Test 1\n")
(check-equal? (interpret "tests/P4test1.txt" "A") 15 "P4test1")
(printf "\nP4Test 2\n")
(check-equal? (interpret "tests/P4test2.txt" "A") 12 "P4test2")
(printf "\nP4Test 3\n")
(check-equal? (interpret "tests/P4test3.txt" "A") 125 "P4test3")
(printf "\nP4Test 4\n")
(check-equal? (interpret "tests/P4test4.txt" "A") 36 "P4test4")
; (printf "\nP4Test 5\n")
; (check-equal? (interpret "tests/P4test5.txt" "A") 54 "P4test5")
; (printf "\nP4Test 6\n")
; (check-equal? (interpret "tests/P4test6.txt" "A") 110 "P4test6")
; (printf "\nP4Test 7\n")
; (check-equal? (interpret "tests/P4test7.txt" "C") 26 "P4test7")
; (printf "\nP4Test 8\n")
; (check-equal? (interpret "tests/P4test8.txt" "Square") 117 "P4test8")
; (printf "\nP4Test 9\n")
; (check-equal? (interpret "tests/P4test9.txt" "Square") 32 "P4test9")
; (printf "\nP4Test 10\n")
; (check-equal? (interpret "tests/P4test10.txt" "List") 15 "P4test10")
; (printf "\nP4Test 11\n")
; (check-equal? (interpret "tests/P4test11.txt" "List") 123456 "P4test11")
; (printf "\nP4Test 12\n")
; (check-equal? (interpret "tests/P4test12.txt" "List") 5285 "P4test12")
; (printf "\nP4Test 13\n")
; (check-equal? (interpret "tests/P4test13.txt" "C") -716 "P4test13")